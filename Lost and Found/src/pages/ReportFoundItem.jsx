...
import { Upload, Loader2, PackageCheck } from 'lucide-react'
...
export function ReportFoundItem() {
  ...
  if (!isAuthenticated) {
    return (
      <DashboardLayout title="Report Found Item">
        <div className="text-center py-16">
          <h2 className="text-2xl font-bold text-white mb-4">Sign in Required</h2>
          <p className="text-slate-400 mb-8">Please sign in to report a found item.</p>
        ...
        <Card className="overflow-hidden border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl">
          <CardHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <CardTitle className="text-3xl text-white">Report Found Item</CardTitle>
                <CardDescription className="text-slate-300">
                  Tell us about the item you found so we can help reunite it with its owner.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium mb-2 block text-white">Found Location</label>
                  <Input
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block text-white">Date Found</label>
                  <Input
                    type="date"
